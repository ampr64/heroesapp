...
{
    public class HeroBusinessLayer : IHeroBusinessLayer
    {
        private IGenericRepository<Hero> repository;

        public HeroBusinessLayer(IGenericRepository<Hero> repository)
        {
